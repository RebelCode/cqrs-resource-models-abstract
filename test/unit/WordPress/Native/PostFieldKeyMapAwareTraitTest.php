...
use stdClass;
use Xpmock\TestCase;
use RebelCode\Storage\Resource\WordPress\Native\PostFieldKeyMapAwareTrait as TestSubject;
...
class PostFieldKeyMapAwareTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Native\PostFieldKeyMapAwareTrait';
