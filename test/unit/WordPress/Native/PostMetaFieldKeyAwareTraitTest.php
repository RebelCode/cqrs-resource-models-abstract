...
use stdClass;
use Xpmock\TestCase;
use RebelCode\Storage\Resource\WordPress\Native\PostMetaFieldKeyAwareTrait as TestSubject;
...
class PostMetaFieldKeyAwareTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Native\PostMetaFieldKeyAwareTrait';
