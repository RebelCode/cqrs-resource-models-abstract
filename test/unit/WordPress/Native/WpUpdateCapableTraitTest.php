...
use RebelCode\Storage\Resource\WordPress\Native\WpUpdateCapableTrait as TestSubject;
use Xpmock\TestCase;
...
class WpUpdateCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Native\WpUpdateCapableTrait';
