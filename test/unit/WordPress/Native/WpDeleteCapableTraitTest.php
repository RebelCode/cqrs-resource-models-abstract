...
namespace RebelCode\Storage\Resource\WordPress\Native\UnitTest;

use Dhii\Expression\LogicalExpressionInterface;
use InvalidArgumentException;
use RebelCode\Storage\Resource\WordPress\Native\WpDeleteCapableTrait as TestSubject;
use Xpmock\TestCase;
...
class WpDeleteCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Native\WpDeleteCapableTrait';
