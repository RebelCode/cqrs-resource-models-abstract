...
namespace RebelCode\Storage\Resource\WordPress\Wpdb\FuncTest;

use Dhii\Expression\LogicalExpressionInterface;
use RebelCode\Storage\Resource\WordPress\Wpdb\WpdbDeleteCapableTrait as TestSubject;
use Xpmock\TestCase;
...
class WpdbDeleteCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Wpdb\WpdbDeleteCapableTrait';
