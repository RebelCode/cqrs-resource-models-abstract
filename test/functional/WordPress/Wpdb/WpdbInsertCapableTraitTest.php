...
use RebelCode\Storage\Resource\WordPress\Wpdb\WpdbInsertCapableTrait as TestSubject;
use Xpmock\TestCase;
...
class WpdbInsertCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'RebelCode\Storage\Resource\WordPress\Wpdb\WpdbInsertCapableTrait';
